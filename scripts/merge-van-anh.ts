/**
 * One-off: gộp "Vk of Dương Gà" + "Vk a Duong" → "Chị Vân Anh" trên mọi event Firestore.
 * Chạy: npx tsx scripts/merge-van-anh.ts
 */
...
const OLD_NAMES = ['Vk of Dương Gà', 'Vk a Duong', 'Vk of Duong Ga', 'Vk a Dương']
const NEW_NAME = 'Chị Vân Anh'
...
async function main() {
  ...
  for (const item of snap.docs) {
    ...
    eventsUpdated++
    console.log(`Updated event ${item.id} (${data.participants.length} participants)`)
  }
